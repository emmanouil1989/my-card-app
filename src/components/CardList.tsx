...
export default function CardList({ data }: CardListProps) {
  ...
  return (
    <div className="flex h-4/5 pr-4">
      <ul className="grid xl:grid-cols-[300px_300px_300px_300px] lg:grid-cols-[200px_200px_200px] md:grid-cols-[200px_200px] grid-cols-[300px]  xl:auto-rows-[400px] lg:auto-rows-[300px]  md:auto-rows-[300px] auto-rows-[400px] list-inside gap-8  h-full overflow-y-auto pr-4">
