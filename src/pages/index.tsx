...
const Home: NextPage = () => {
  ...
  return (
    <main className=" w-screen flex  pb-12">
      <div className=" flex flex-col justify-center overflow-y-auto w-full  items-center">
          ...
          <div className="flex justify-between items-center py-8 w-full">
            ...
            <div className="w-8/12 h-10 relative">
              ...
              <svg
                ...
                width="28px"
                height="28px"
                className="absolute top-2 right-4 bottom-2"
              >
                <path
